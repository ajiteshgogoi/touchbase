    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {analytics?.contactTopics.map(contact => (
        <div
          ...
          className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-xl border border-gray-100/50 dark:border-gray-800/50 shadow-soft dark:shadow-soft p-4 hover:bg-white/70 hover:shadow-md dark:hover:shadow-lg transition-all duration-200"
        >
