...
export const Terms = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <Helmet>
        <link rel="canonical" href="https://touchbase.site/terms" />
      </Helmet>
      ...
      <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-xl border border-gray-100/50 dark:border-gray-800/50 shadow-soft dark:shadow-soft-dark divide-y divide-gray-100/50 dark:divide-gray-800/50">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">1. Introduction</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400">
            TouchBase is a relationship management tool (personal CRM) designed to help you maintain meaningful connections. By accessing and using TouchBase, you agree to be bound by these Terms of Service and our <a href="/privacy" className="text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300">Privacy Policy</a>. If you do not agree with any of these terms, please do not use the service.
          </p>
        </section>
        ...
        <section className="p-6">
          ...
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400 mb-2">You agree not to:</p>
        ...
        <section className="p-6">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400">
