...
export const Privacy = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <Helmet>
        <link rel="canonical" href="https://touchbase.site/privacy" />
      </Helmet>
      ...
      <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-xl border border-gray-100/50 dark:border-gray-800/50 shadow-soft dark:shadow-soft-dark divide-y divide-gray-100/50 dark:divide-gray-800/50">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">3. Technical Security Measures</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400 mb-2">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">4. AI Features</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400 mb-2">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">5. Data Storage</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">6. User Controls</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">7. Data Usage</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">8. Data Deletion</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">9. Children's Privacy</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">10. Changes to Privacy Policy</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400">
        ...
        <section className="p-6">
          <h2 className="text-xl font-[600] text-gray-900/90 dark:text-white mb-4">11. Contact Us</h2>
          <p className="text-[15px] leading-relaxed text-gray-600/90 dark:text-gray-400">
            If you have questions about this Privacy Policy or your data, please visit our <a href="/support" className="text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300">Support page</a>. We aim to respond to all enquiries within 48 hours.
          </p>
        </section>
      </div>
    </div>
