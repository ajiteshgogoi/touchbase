...
export default function BlogList() {
  ...
  useEffect(() => {
    const loadPosts = async () => {
      try {
        // Try to fetch static JSON first (production)
        ...
        // Fallback to direct file reading (development)
        console.log('Falling back to direct file reading');
      }

      // Development mode: use utils directly
