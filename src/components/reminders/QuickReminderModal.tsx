                  ...
                  <div className="flex-1 overflow-y-auto p-6 space-y-4 min-h-0">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="block w-full rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus:outline-none focus:border-primary-400 dark:focus:border-primary-500 focus:ring-1 focus:ring-primary-400 dark:focus:ring-primary-500 transition-colors duration-200 text-gray-900 dark:text-white [&::-webkit-calendar-picker-indicator]:filter [&::-webkit-calendar-picker-indicator]:invert-[0.4] dark:[&::-webkit-calendar-picker-indicator]:invert-[0.65]"
                        required
                      />
                    </div>
