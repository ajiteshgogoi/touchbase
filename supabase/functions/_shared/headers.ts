...
export function addSecurityHeaders(headers: Headers = new Headers()): Headers {
  ...
  headers.set('Permissions-Policy', "vibrate=*, notifications=*, geolocation=self, payment=*, digital-goods=(self \"https://play.google.com\"), camera=self, microphone=self, magnetometer=self, accelerometer=self, gyroscope=self");
